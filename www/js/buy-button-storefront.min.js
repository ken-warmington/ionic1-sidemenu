...
var ShopifyBuy = function () {
	...
	function n(t) {
		return t && "object" == typeof t && "default" in t ? t.default:
		t
	}
	function i(t, e) {
		return e = {
	...
	T = i(function (e) {
			...
			function b(t) {
				...
				default:
					...
					n = Eo + "." + m(),
					null === t[Io] ? t[Io] = n : (qo.value = n, Object.defineProperty(t, Io, qo))
				}
				return n
			}
			function _(t, e) {
			...
			!function () {
				...
				function u(t, e) {
					...
					if (u.prototype.isPrototypeOf(t)) {
						...
						this.url = t;
					if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new n(e.headers)), this.method = c(e.method || this.method || "GET"), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && i)
				...
				function h(t, e) {
					...
					this.headers = e.headers instanceof n ? e.headers : new n(e.headers),
					this.url = e.url || ""
				}
				if (!self.fetch) {
					...
					self.fetch = function (t, e) {
						return new Promise(function (n, i) {
							...
							"responseType" in a && d.blob && (a.responseType = "blob"),
			...
			ut = i(function (t) {
					...
					(t.exports = function (t, r, a, c) {
						...
						u && (i(a, "name") || n(a, "name", r)),
						t[r] !== a && (u && (i(a, o) || n(a, o, t[r] ? "" + t[r] : s.join(String(r)))), t === e ? t[r] = a : c ? t[r] ? t[r] = a : n(t, r, a) : (delete t[r], n(t, r, a)))
			...
			lt = {};
			lt[A("toStringTag")] = "z",
			lt + "" != "[object z]" && ut(Object.prototype, "toString", function () {
			...
			Tt = function t(e, n, i) {
				...
				u && (i = n);
				for (o in i)
					r = !c && d && void 0 !== d[o], a = (r ? d : i)[o], s = h && r ? Et(a, kt) : l && "function" == typeof a ? Et(Function.call, a) : a, d && zt(d, o, a, e & t.U), f[o] != a && It(f, o, s), l && y[o] != a && (y[o] = a)
			};
			kt.core = Ct,
			Tt.F = 1,
			Tt.G = 2,
			...
			ue = U ? Object.defineProperties : function (t, e) {
				se(t);
				for (var n, i = ce(e), o = i.length, r = 0; o > r; )
					ae.f(t, n = i[r++], e[n]);
				return t
			},
			...
			be = function () {
				...
				i = "<",
				o = ">";
				for (e.style.display = "none", pe.appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write(i + "script" + o + "document.F=Object" + i + "/script" + o), t.close(), be = t.F; n--; )
					delete be[me][de[n]];
				return be()
			},
			_e = Object.create || function (t, e) {
				var n;
				return null !== t ? (ye[me] = le(t), n = new ye, ye[me] = null, n[fe] = t) : n = be(),
				void 0 === e ? n : he(n, e)
			},
			ge = et.f,
			ve = st,
			...
			je = Object.getPrototypeOf || function (t) {
				return t = Oe(t),
				Se(t, Ae) ? t[Ae] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? Pe : null
			},
			Ne = gt,
			Fe = St,
			De = ut,
			...
			Fn = ct.getIteratorMethod = function (t) {
				if (void 0 != t)
					return t[jn] || t["@@iterator"] || Nn[Pn(t)]
			},
			Dn = i(function (t) {
					var e = xt,
					n = qn,
					...
					u = t.exports = function (t, u, p, l, h) {
						...
						if (i(b)) {
							for (d = r(t.length); d > g; g++)
								if (m = u ? _(o(f = t[g])[0], f[1]) : _(t[g]), m === s || m === c)
									return m
						} else
							for (y = b.call(t); !(f = y.next()).done; )
								if (m = n(y, _, f.value, u), m === s || m === c)
									return m
					};
					u.BREAK = s,
					u.RETURN = c
			...
			Qi = xi = function (t) {
				...
				this.promise = new t(function (t, i) {
						if (void 0 !== e || void 0 !== n)
							throw Vi("Bad Promise constructor");
						e = t,
						n = i
					}),
				this.resolve = Oi(e),
			...
			to = function t(e) {
				...
				if (!i._d) {
					...
					try {
						if (i === e)
							throw Vi("Promise can't be resolved itself");
						(n = Ki(e)) ? Fi(function () {
							var o = {
								_w: i,
								_d: !1
			...
			var t = new wi;
			this.promise = t,
			this.resolve = Ei(to, t, 1),
			this.reject = Ei(Zi, t, 1)
		}),
		...
		Ti(Ti.S + Ti.F * (Ii || !Li), Di, {
			resolve: function (t) {
				if (t instanceof Ri && Hi(t.constructor, this))
					return t;
				var e = Wi(this),
				n = e.resolve;
				return n(t),
		...
		no = i(function (t, e) {
				!function () {
					...
					n.btoa || (n.btoa = function (e) {
						...
						n.atob || (n.atob = function (e) {
							...
							for (var o, r, a = 0, s = 0, c = ""; r = n.charAt(s++); ~r && (o = a % 4 ? 64 * o + r : r, a++ % 4) ? c += String.fromCharCode(255 & o >> (-2 * a & 6)) : 0)
								r = i.indexOf(r);
							return c
						})
					}
			...
			ho = uo.extend({
					constructor: function (t) {
						...
						this.requiredProperties.forEach(function (n) {
							if (!t.hasOwnProperty(n))
								throw new Error("new Config() requires the option '" + n + "'");
							e[n] = t[n]
						}),
					...
					transformMyShopifyDomain: function (t, e) {
						lo.warn("Config - ", "myShopifyDomain is deprecated, please use domain and provide the full shop domain."),
						e.domain = t + ".myshopify.com"
					},
					requiredProperties: ["apiKey", "appId", "domain", "discount", "note"],
			...
			go = yo.extend(Object.defineProperties({
						...
						checkoutUrl: function () {
							...
							o = "access_token=" + e.apiKey + "&_fd=0" + "&discount=" + t.discount;
							return n + "/" + i + "?" + o
						}
					}, {
						id: {
			...
			xo = yo.extend(Object.defineProperties({
						...
						memoized: {
							get: function () {
								return this._memoized = this._memoized || {},
								this._memoized
							},
							configurable: !0,
							enumerable: !0
						...
						variants: {
							get: function () {
								...
								return this.attrs.variants.map(function (e) {
									// console.log('index.html variants_get_this.attrs.variants.map() e='+e);
			...
			ko = uo.extend({
					constructor: function (t) {
						this.config = t;
						// console.log('index.html uo.extend_constructor() this.config.note='+this.config.note);
					},
						...
						buildMultipleUrl: function (t) {
							...
							if (i.length > 0) {
								var o = i.map(function (t) {
										var n = void 0;
										return n = Array.isArray(e[t]) ? e[t].join(",") : e[t],
			...
			zo = yo.extend(Object.defineProperties({
						...
						note: {
							get: function () {
								// console.log('index.html note:get() start this.attrs.note='+this.attrs.note);
						...
						properties: {
							...
							set: function (t) {
								return this.attrs.properties = t || {},
								t
							},
							configurable: !0,
							enumerable: !0
			...
			Ao = yo.extend(Object.defineProperties({
						...
						addVariants: function () {
							return lo.warn("CartModel - ", "addVariants is deprecated, please use createLineItemsFromVariants instead"),
							this.createLineItemsFromVariants.apply(this, arguments)
						},
						createLineItemsFromVariants: function () {
							var c = this.config,
							 t = [].concat(Array.prototype.slice.call(arguments)).map(function (t) {
								var e = {
							...
							var i = e.reduce(function (t, e) {
									...
									return n ? n.quantity = n.quantity + e.quantity : t.push(e),
									t
								}, []);
							return this.attrs.line_items = i.reduce(function (t, e) {
									return e.quantity >= 1 && t.push(e),
									t
								}, []),
							this.updateModel()
						},
						...
						updateModel: function () {
							...
							return this.shopClient.update("carts", this).then(function (e) {
								if(t.attrs.line_items.length === 0)
								{
									console.log('cart is empty');
									window.localStorage.removeItem("buyerIds");
									window.localStorage.removeItem("buyNowArray");
									t.cache = {};
									t.buyNowArray = [];
								}
								return ao(t.attrs, e.attrs),
								t
							})
						}
					}, {
						...
						checkoutUrl: {
							get: function () {
								...
								j = this.lineItems.map(function(t){
									if(window.localStorage.getItem("buyNowArray"))
									{
										buyNowArray = JSON.parse(window.localStorage.getItem("buyNowArray"));
									}else
									{
										buyNowArray = [];
									}
									//buyerIds
									if(window.localStorage.getItem("buyerIds"))
									{
										//buyerIds = JSON.parse(window.localStorage.getItem("buyerIds"));
										buyerIds = window.localStorage.getItem("buyerIds");
									}
									
									var array = []
									for (var index_i = 0; index_i < buyNowArray.length; index_i++) { 
										if(buyNowArray[index_i].id === t.variant_id)
										{
											array = buyNowArray[index_i].value
											break;
										}
									}
									if(array.length > 0){
										var str = "";
										for(var index_i = 0; index_i < array.length; index_i++)
										{
											str = str + t.variant_id+":"+array[index_i]+","
										}
										...
										return "LOOPSPOT|"+buyerIds+"|"+str;
									}
			
									return "LOOPSPOT" +"|"+buyerIds; //t.variant_id + ":" + t.note
								}),
								// j = this.lineItems.map(function (t) {
								// 	  var variantAndNote='';
								// 	  // example 60562929099:ruid46,60562929163:ruid46 used in Backend when we calculate commission
								// 	  var variantRuids='';
								// 	  var elementVariantRuids=document.getElementById('variantRuids');
								// 	  if ( elementVariantRuids ) {
								// 		variantRuids=document.getElementById('variantRuids').value;  
								// 	  }
								// 	  // console.log('index.html checkoutUrl_get() variantRuids=',variantRuids);
									  
								// 	  //check for match on variantRuid and no commas
								// 	  if ( variantRuids.lastIndexOf(t.variant_id+':ruid') > -1 && variantRuids.lastIndexOf(',') < 0  ) {  
								// 		variantAndNote=variantRuids;
								// 	  }
		  
								// 	  //check for match on variantRuid and commas
								// 	  if ( variantRuids.lastIndexOf(t.variant_id+':ruid') > -1 && variantRuids.lastIndexOf(',') > 0  ) {
								// 		var str_array = variantRuids.split(',');
								// 		for(var i = 0; i < str_array.length; i++) {
								// 		  var variantRuid=str_array[i];
								// 		  if ( variantRuid.lastIndexOf(t.variant_id+':ruid') > -1 ) {
								// 			variantAndNote=variantRuid;	  
								// 		  }
								// 		}
								// 	  }
									  		  
								// 	  console.log('index.html checkoutUrl_get() variantAndNote=',variantAndNote);
								// 	  return variantAndNote;
								// 	}),
								o = "access_token=" + t.apiKey + "&_fd=0" + "&discount=" + t.discount;
			...
			jo = yo.extend(Object.defineProperties({
						constructor: function (t) {
							if (Object.keys(t).indexOf("referenceId") < 0)
			...
			Fo = uo.extend({
					...
					setItem: function (t, e) {
						return this.localStorageAvailable ? localStorage.setItem(t, JSON.stringify(e)) : this.cache[t] = e,
						e
					},
					getItem: function (t) {
			...
			Do = uo.extend({
					...
					create: function (t, e) {
						...
						return new Promise(function (i) {
							var o = n.identify(e);
							n.store.setItem(n.storageKey(t, o), e),
							i(e)
						})
					},
					update: function (t, e, n) {
						...
						return new Promise(function (o) {
							i.store.setItem(i.storageKey(t, e), n),
							o(n)
						})
					},
						...
						fetchRecentCart: function () {
							...
							return this.fetch("references", this.config.domain + ".recent-cart").then(function (e) {
								...
								return t.createCart().then(function (e) {
									...
									return n[Io] = t.config.domain + ".recent-cart",
									t.create("references", n),
									e
								})
							})
						}
			...
			var Mo = {
				...
				buildClient: function () {
					// console.log('index.html buildClient() start');
					
					var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
					e = new this.Config(t);
					// console.log('index.html buildClient() t.note='+t.note);
					// console.log('index.html buildClient() e.note='+e.note);
	...
	G = i(function (t) {
			...
			function n(t) {
				...
				var e;
				return u && u.createContextualFragment ? e = u.createContextualFragment(t) : (e = document.createElement("body"), e.innerHTML = t),
				e.childNodes[0]
			}
			function i() {}
			function o(t, e) {
			...
			function r(t, e) {
				...
				for (n = c.length - 1; n >= 0; n--)
					i = c[n], o = i.name, a = i.value, r = i.namespaceURI, r ? (o = i.localName || o, s = t.getAttributeNS(r, o)) : s = t.getAttribute(o), s !== a && (r ? t.setAttributeNS(r, o, a) : t.setAttribute(o, a));
				for (c = t.attributes, n = c.length - 1; n >= 0; n--)
					i = c[n], i.specified !== !1 && (o = i.name, r = i.namespaceURI, p(e, r, r ? o = i.localName || o : o) || (r ? t.removeAttributeNS(r, i.localName) : t.removeAttribute(o)))
			}
			function a(t, e) {
			...
			function c(t, c, u) {
				function p(t, e) {
					...
					if (n ? v[n] = t : e || q(t), t.nodeType === d)
						for (var i = t.firstChild; i; )
							p(i, e || n), i = i.nextSibling
				}
				function l(t) {
					if (t.nodeType === d)
						for (var e = t.firstChild; e; )
							x(e) || (q(e), l(e)), e = e.nextSibling
				}
				function h(t, e, n) {
					...
					if ("TEXTAREA" !== t.nodeName) {
						...
						t: for (; l; ) {
							for (c = l.nextSibling, a = x(l); g; ) {
								var E = x(g);
								if (s = g.nextSibling, !n && E && (p = w[E]))
									p.parentNode.replaceChild(g, p), _(g, p, n), g = s;
								else {
									var S = g.nodeType;
									if (S === l.nodeType) {
										var A = !1;
							...
							a && ((u = v[a]) ? b(u, l) ? (_(u, l, !0), l = u) : (delete v[a], q(u)) : w[a] = l),
							k(l) !== !1 && (t.appendChild(l), C(l)),
							l.nodeType === d && (a || l.firstChild) && O.push(l),
							l = c,
							g = s
						}
						for (; g; )
							s = g.nextSibling, h(g, t, n), g = s
					}
					var P = m[t.nodeName];
					P && P(t, e)
				}
				...
				if (!S)
					if (P === d)
						j === d ? b(t, c) || (q(t), A = a(t, o(c.nodeName, c.namespaceURI))) : A = c;
					else if (P === f || P === y) {
						if (j === P)
							return A.nodeValue = c.nodeValue, A;
						A = c
					}
				if (A === c)
					q(t);
					...
					var N = function (t) {
						for (var n = t.firstChild; n; ) {
							...
							if (o) {
								var r = v[o];
								if (r && b(n, r)) {
									if (n.parentNode.replaceChild(r, n), _(r, n, !0), n = i, e(v))
										return !1;
									continue
								}
							}
				...
				return !S && A !== t && t.parentNode && t.parentNode.replaceChild(A, t),
				A
			}
			var u,
			p,
			l = "undefined" != typeof document ? document.body || document.createElement("div") : {},
			...
			var m = {
				...
				INPUT: function (t, e) {
					...
					p(e, null, "value") || t.removeAttribute("value"),
	...
	J = i(function (t, e) {
			...
			(q, function (t) {
				...
				function c(e, n) {
					...
					for (var C, I, z, E, q, T, S = new l(e); !S.eos(); ) {
						if (C = S.pos, z = S.scanUntil(s))
							for (var O = 0, A = z.length; O < A; ++O)
								E = z.charAt(O), a(E) ? m.push(f.length) : _ = !0, f.push(["text", E, C, C + 1]), C += 1, "\n" === E && o();
						if (!S.scan(s))
							break;
						if (b = !0, I = S.scan(k) || "name", S.scan(g), "=" === I ? (z = S.scanUntil(w), S.scan(w), S.scanUntil(c)) : "{" === I ? (z = S.scanUntil(h), S.scan(x), S.scanUntil(c), I = "&") : z = S.scanUntil(c), !S.scan(c))
							throw new Error("Unclosed tag at " + S.pos);
						if (q = [I, z, C, S.pos], f.push(q), "#" === I || "^" === I)
							d.push(q);
						else if ("/" === I) {
							if (T = d.pop(), !T)
								throw new Error('Unopened section "' + z + '" at ' + C);
							if (T[1] !== z)
								throw new Error('Unclosed section "' + T[1] + '" at ' + C)
						} else
							"name" === I || "{" === I || "&" === I ? _ = !0 : "=" === I && r(z)
					}
					if (T = d.pop())
						throw new Error('Unclosed section "' + T[1] + '" at ' + S.pos);
					return p(u(f))
				}
				function u(t) {
					for (var e, n, i = [], o = 0, r = t.length; o < r; ++o)
						e = t[o], e && ("text" === e[0] && n && "text" === n[0] ? (n[1] += e[1], n[3] = e[3]) : (i.push(e), n = e));
					return i
				}
				function p(t) {
				...
				h.prototype.lookup = function (t) {
					...
					if (i.hasOwnProperty(t))
						...
						for (var r, a, s = this, c = !1; s; ) {
							if (t.indexOf(".") > 0)
								for (n = s.view, r = t.split("."), a = 0; null != n && a < r.length; )
									a === r.length - 1 && (c = o(n, r[a])), n = n[r[a++]];
							else
								n = s.view[t], c = o(s.view, t);
							if (c)
								break;
							s = s.parent
						}
				...
				d.prototype.renderTokens = function (t, e, n, i) {
					for (var o, r, a, s = "", c = 0, u = t.length; c < u; ++c)
						a = void 0, o = t[c], r = o[0], "#" === r ? a = this.renderSection(o, e, n, i) : "^" === r ? a = this.renderInverted(o, e, n, i) : ">" === r ? a = this.renderPartial(o, e, n, i) : "&" === r ? a = this.unescapedValue(o, e) : "name" === r ? a = this.escapedValue(o, e) : "text" === r && (a = this.rawValue(o)), void 0 !== a && (s += a);
					return s
				},
					...
					if (c) {
						if (y(c))
							for (var u = 0, p = c.length; u < p; ++u)
								s += this.renderTokens(t[4], n.push(c[u]), i, o);
						else if ("object" == typeof c || "string" == typeof c || "number" == typeof c)
							s += this.renderTokens(t[4], n.push(c), i, o);
						else if (e(c)) {
							if ("string" != typeof o)
								throw new Error("Cannot use higher-order sections without the original template");
							c = c.call(n.view, o.slice(t[3], t[5]), r),
							null != c && (s += c)
						} else
		...
		M(t, [{
					...
					get: function () {
						...
						return this.order.reduce(function (e, n) {
							var i = "";
							return t.contents[n] && (i = t.templates[n] || ""),
							e + i
						}, "")
					}
				}
	...
	at = function () {
		function t(e, n) {
			...
			this.parent = e,
			this.stylesheet = n.stylesheet,
			this.customStylesHash = n.customStyles || {},
			this.classes = n.classes,
			this.browserFeatures = n.browserFeatures,
			this.googleFonts = n.googleFonts || [],
			this.name = n.name,
			n.width && this.setWidth(n.width),
			...
			this.el.setAttribute("name", n.name),
			this.styleTag = null
		}
	...
	pt = function () {
		function t(e) {
			...
			this.template = new tt(this.component.options.templates, this.component.options.contents, this.component.options.order)
		}
		return t.prototype.init = function () {
			return this.component.node.className += " shopify-buy-frame shopify-buy-frame--" + this.component.typeKey,
			this.iframe || !this.component.options.iframe ? Promise.resolve(this.iframe) : (this.iframe = new at(this.component.node, {
	...
	lt = function () {
		...
		return t.prototype.updateConfig = function (t) {
			this.component.config = o(this.component.config, t.options),
			this.component.view.template = new tt(this.component.options.templates, this.component.options.contents, this.component.options.order),
	...
	ht = function () {
		function t(e, n) {
			...
			this.config = o({}, B, e.options || {}),
			this.props = n,
			this.model = {},
			this.updater = new lt(this),
		...
		return t.prototype.init = function (t) {
			...
			this.view.init().then(function () {
				...
				throw t.message.indexOf("Not Found") > -1 && c(e),
				t
			})
		},
		...
		t.prototype._userEvent = function (t) {
			this.globalConfig.debug && Y.info("EVENT: " + t + " (" + this.typeKey + ")"),
			r(this.events[t]) && this.events[t].call(this, this)
		},
		M(t, [{
					key: "name",
					get: function () {
						var t = "";
						return this.id ? t = "-" + this.id : this.handle && (t = "-" + this.handle),
						"frame-" + this.typeKey + t
					}
				}, {
					key: "options",
					get: function () {
					...
					get: function () {
						...
						return this.options.manifest.filter(function (e) {
							...
							return e[n] = Object.keys(t.config[n].classes).reduce(function (e, i) {
									return e[i] = "." + t.classes[n][i].split(" ").join("."),
									e
								}, {}),
							e
						}, {})
	...
	vt = function (t) {
		...
		e.prototype.updateConfig = function (e) {
			var n = this;
			if (e.id || e.variantId)
				return this.component.id = e.id || this.component.id, this.component.defaultVariantId = e.variantId || this.component.defaultVariantId, void this.component.init();
			var i = this.component.options.layout;
			e.options && e.options.product && (e.options.product.layout && (i = e.options.product.layout), this.component.view.iframe && ("vertical" === i && this.component.view.iframe.width === gt && this.component.view.iframe.setWidth(this.component.options.width), "horizontal" === i && this.component.view.iframe.width && this.component.view.iframe.width !== gt && this.component.view.iframe.setWidth(gt), e.options.product.width && "vertical" === i && this.component.view.iframe.setWidth(e.options.product.width), e.options.product.layout && (this.component.view.iframe.el.style.width = "100%"))),
			this.component.view.iframe && (this.component.view.iframe.removeClass(this.component.classes.product.vertical), this.component.view.iframe.removeClass(this.component.classes.product.horizontal), this.component.view.iframe.addClass(this.component.classes.product[i]), this.component.view.resizeUntilLoaded()),
			[].concat(Q(this.component.view.wrapper.querySelectorAll("img"))).forEach(function (t) {
			...
			this.component.modal && this.component.modal.updateConfig(L({}, e, {
	...
	kt = function (t) {
		function e(n, i) {
			...
			return o.typeKey = "product",
			o.defaultVariantId = n.variantId,
			o.cachedImage = null,
			o.childTemplate = new tt(o.config.option.templates, o.config.option.contents, o.config.option.order),
			o.cart = null,
			o.modal = null,
			o.imgStyle = "",
		...
		e.prototype.onCarouselItemClick = function (t, e) {
			...
			o && (this.selectedImage = o, this.cachedImage = o),
			this.view.render()
		},
		...
		e.prototype.onCarouselChange = function (t) {
			...
			o = n.indexOf(i);
			this.selectedImage = n[this.nextIndex(o, t)],
		...
		e.prototype.updateVariant = function (t, e) {
			...
			return n.selected = e,
			this.variantExists && (this.cachedImage = this.model.selectedVariantImage),
			this.view.render(),
		...
		M(e, [{
					...
					get: function () {
						...
						this.options.imageSize && (n = this.options.imageSize);
						...
						L({}, i.variants.filter(function (t) {
								return t.name === n
							})[0], {
							id: i.id
						})
					...
					get: function () {
						...
						return this.options.contents.options ? this.decoratedOptions.reduce(function (e, n) {
							...
							return i.classes = t.classes,
							i.onlyOption = 1 === t.model.options.length,
					...
					get: function () {
						...
						return e = this.config.product.styles ? o({}, Object.keys(this.config.product.styles).reduce(function (e, n) {
									return e[n] = x(t.config.product.styles[n]),
									e
								}, {}), this.config.modalProduct.styles) : {},
						L({}, this.config.modalProduct, {
							styles: e
						})
					}
				}, {
	...
	Ct = function (t) {
		...
		e.prototype.close = function () {
			...
			p("is-active", this.wrapper),
			p("is-active", this.document.body),
			p("shopify-buy-modal-is-active", document.body),
			p("shopify-buy-modal-is-active", document.getElementsByTagName("html")[0]),
			this.iframe ? (this.iframe.removeClass("is-block"), void(this.component.props.browserFeatures.transition ? this.iframe.parent.addEventListener("transitionend", function () {
	...
	It = function (t) {
		...
		e.prototype.updateConfig = function (e) {
			...
			this.component.product = new kt(this.component.productConfig, this.component.props),
	...
	zt = function (t) {
		function e(n, i) {
			R(this, e);
			var o = K(this, t.call(this, n, i));
			return o.typeKey = "modal",
			o.node = n.node ? n.node.appendChild(document.createElement("div")) : document.body.appendChild(document.createElement("div")),
			o.node.className = "shopify-buy-modal-wrapper",
			o.product = null,
			o.updater = new It(o),
			o.view = new Ct(o),
			o
		...
		e.prototype.init = function (e) {
			...
			t.prototype.init.call(this, e).then(function () {
				...
				n.product = new kt(n.productConfig, n.props),
	...
	Tt = function (t) {
		...
		e.prototype.resizeUntilFits = function () {
			...
			if (this.iframe && !this.resizeCompleted) {
				...
				var i = setInterval(function () {
						var o = t.outerHeight;
						parseInt(o, 10) > parseInt(t.height, 10) && (n++, t.height = o, t.resize(o)),
						n > e && (t.resizeCompleted = !0, clearInterval(i))
					}, qt)
			}
		},
		M(e, [{
	...
	St = function (t) {
		...
		e.prototype.sdkFetch = function () {
			...
			if (this.id) {
				var o = void 0;
				k(this.id) ? o = "product_ids" : (o = "collection_id", n.sort_by = "collection-default"),
				i = this.props.client.fetchQueryProducts(L({}, n, U({}, o, this.id)))
			} else
				this.handle && (i = this.props.client.fetchQueryCollections({
							handle: this.handle
						}).then(function (n) {
							if (n.length) {
								var i = n[0];
								return t.id = i.attrs.collection_id,
								t.sdkFetch(e)
							}
							return Promise.resolve([])
						}));
		...
		e.prototype.renderProducts = function () {
			...
			n = this.model.products.map(function (n) {
					...
					return t.products.push(i),
					i.init(n)
				});
			return Promise.all(n).then(function () {
				return t.view.resizeUntilFits(),
				t.showPagination(),
				t
			})
		},
	...
	At = function (t) {
		...
		e.prototype.render = function () {
			...
			this.iframe && (this.iframe.parent.setAttribute("tabindex", 0), this.resize())
		},
		e.prototype.delegateEvents = function () {
			var e = this;
			t.prototype.delegateEvents.call(this),
	...
	Pt = function (t) {
		function e(n, i) {
			R(this, e);
			var o = K(this, t.call(this, n, i));
			return o.typeKey = "toggle",
			o.node = n.node || o.props.cart.node.parentNode.insertBefore(document.createElement("div"), o.props.cart.node),
			o.view = new At(o),
			o
		}
		return H(e, t),
		e.prototype.toggleCart = function (t) {
			t.stopPropagation(),
	...
	jt = function (t) {
		function e(n) {
			R(this, e);
			var i = K(this, t.call(this, n));
			return i.node.className = "shopify-buy-cart-wrapper",
			i
		}
		return H(e, t),
		e.prototype.render = function () {
			t.prototype.render.call(this),
			this.component.isVisible ? (this.addClass("is-active"), this.addClass("is-initialized")) : this.removeClass("is-active")
		},
		e.prototype.wrapTemplate = function (t) {
	...
	Dt = function (t) {
		function e(n, i) {
			...
			r.addVariantToCart = r.addVariantToCart.bind(r),
			r.childTemplate = new tt(r.config.lineItem.templates, r.config.lineItem.contents, r.config.lineItem.order),
			r.node = n.node || document.body.appendChild(document.createElement("div")),
			r.isVisible = r.options.startOpen,
			r.checkout = new dt(r.config);
		...
		return H(e, t),
		e.prototype.createToggles = function (t) {
			var e = this;
		...
		e.prototype.toggleVisibility = function (t) {
			...
			this.view.render(),
			this.isVisible && this.view.setFocus()
		},
		e.prototype.onQuantityBlur = function (t, e) {
		...
		e.prototype.updateItem = function (t, e) {
			var n = this;
			return this._userEvent("updateItemQuantity"),
			this.model.updateLineItem(t, e).then(function (i) {
				return n.model = i,
		...
		e.prototype.addVariantToCart = function (t) {
			...
			if(pathName.indexOf("/productreview/") !== -1)
			{
				var array = pathName.split("/");
				var reviewId = array[array.length-1];
				var varientId = t.attrs.variant.id;

				var findKey = false
				for (i = 0; i < buyNowArray.length; i++) { 
					if(buyNowArray[i].id === varientId)
					{
						buyNowArray[i].value.push("ruid"+reviewId);
						findKey = true;
						break;
					}
				}
				...
				if(!findKey)
				{
					...
					newObj.id = varientId;
					newObj.value = [];
					newObj.value.push("ruid"+reviewId);
					buyNowArray.push(newObj);
				}

				window.localStorage.setItem("buyNowArray", JSON.stringify(buyNowArray))
			}
			
		    
			//memoryString = memoryString + t.attrs.variant.id+":"+t.config.note+","
		...
		M(e, [{
					...
					get: function () {
						...
						return this.model.lineItems.reduce(function (e, n) {
							var i = o(n, t.options.viewData);
							return i.classes = t.classes,
							i.lineItemImage = t.imageForLineItem(i),
							i.variantTitle = "Default Title" === i.variant_title ? "" : i.variant_title,
							i.formattedPrice = _(i.line_price, t.globalConfig.moneyFormat),
							e + t.childTemplate.render({
								data: i
							}, function (e) {
	...
	if (window.requestAnimationFrame && window.cancelAnimationFrame)
		Mt.requestAnimationFrame = window.requestAnimationFrame, Mt.cancelAnimationFrame = window.cancelAnimationFrame;
	else {
		for (var Ht = 0; Ht < Lt.length && !Mt.requestAnimationFrame; ++Ht)
			Mt.requestAnimationFrame = window[Lt[Ht] + "RequestAnimationFrame"], Mt.cancelAnimationFrame = window[Lt[Ht] + "CancelAnimationFrame"] || window[Lt[Ht] + "CancelRequestAnimationFrame"];
	...
	Jt = function () {
		function t(e) {
			...
			this.tracker = new Vt(n.tracker, this.client.config),
			this.styleOverrides = i,
		...
		return t.prototype.createComponent = function (t, e) {
			...
			return i.iframe && this._bindEsc(i.iframe.el.contentWindow || i.iframe.el),
			this.components[t].push(i),
			i.init().then(function () {
				return n.trackComponent(t, i),
				i
			}).catch (function (t) {
	...
	();
	window.ShopifyBuy = window.ShopifyBuy || S,
	S.UI = window.ShopifyBuy.UI || {
		domains: {},
		init: function (t) {
			...
			n = arguments[2],
			i = t.config.domain;
			return this.domains[i] || (this.domains[i] = new Jt(t, e, n)),
			this.domains[i]
		},
		adapterHelpers: {
			templates: {
	...
	ie = e(function (t, e) {
			function n(t) {
				var e = [];
				for (var n in t)
					("number" == typeof t[n] || t[n]) && ("object" == typeof t[n] && 0 === Object.keys(t[n]).length || e.push(encodeURIComponent(n) + "=" + encodeURIComponent(t[n])));
				return e.join("&")
			}
			function i(t) {
				var e = new Image(1, 1);
	...
	oe = e(function (t, e) {
			...
			function i(t, e, n) {
				void 0 === n && (n = {}),
				o() && (a(t, e, n.permanent, r(window.location.hostname)), a(t, e, n.permanent, l), a(t, e, n.permanent, n.domain), a(t, e, n.permanent, ""))
			}
			function o() {
			...
			e.cookie = {
				...
				write: function (t, e, n) {
					...
					return n.maxage && (n.expires = new Date(Date.now() + n.maxage)),
	...
	re = e(function (t, e) {
			...
			var c = oe;
			e.deprecatedShortTermKey = "_s",
			e.shortTermKey = "_shopify_s",
			e.deprecatedLongTermKey = "_y",
			e.longTermKey = "_shopify_y",
			e.firstSeenKey = "_shopify_fs";
			...
			l = {
				...
				fetchOrSet: function () {
					...
					return c.write(e.firstSeenKey, t, n),
					t
				}
			};
			e.hasShortTerm = n,
	...
	pe = function (t) {
		function e(e, n) {
			...
			e.defaultAttributes && (this.defaultAttributes = se.Integration.merge(e.defaultAttributes, this.defaultAttributes)),
			n()
		}
		return ae(e, t),
		...
		e.prototype.emit = function (t, e) {
			...
			e = se.Integration.flatten(e),
			e.eventType = t,
			ce.load(this.defaultAttributes.appName, t, se.Integration.merge(e, this.defaultAttributes))
		},
		e
	}
	(se.Integration),
	...
	we = function () {
		function t(t, e) {
			...
			this.trekkie = new ge.trekkieClass(t.Trekkie, i),
		...
		t.prototype.page = function (t, e) {
			...
			try {
				...
				n.name = t,
				n.properties = _e.Integration.merge(n.properties, e);
		...
		t.prototype.trackLink = function (t, e, n) {
			...
			try {
				t.addEventListener("click", function (o) {
					...
					i.track(e, n),
					r && "_blank" !== t.target && !i.isMeta(o) && (o.preventDefault(), setTimeout(function () {
							i.setLocation(r)
						}, 0))
				})
			} catch (t) {
		...
		t.prototype.isMeta = function (t) {
			if (t instanceof KeyboardEvent && (t.metaKey || t.altKey || t.ctrlKey || t.shiftKey))
				return !0;
		...
		t.prototype.waitFor = function (t, e) {
			return function () {
				--t,
				t > 0 || 0 === t && setTimeout(e, 0)
			}
		},
		t.prototype.pageDefaults = function () {
			var t = window.location.href,
			e = t.indexOf("?");
			return t = e === -1 ? "" : t.slice(e),
			e = t.indexOf("#"),
			t = e === -1 ? t : t.slice(0, e),
			t = "?" === t ? "" : t, {
		...
		t.prototype.url = function () {
			...
			if (t)
				return t.indexOf("?") > 0 ? t : t + window.location.search;
	...
	Ce = (e(function (t) {
			!function (e, n) {
						...
						if (!t.bugsnag) {
							...
							t.bugsnag = function (i) {
								...
								try {
									...
									throw h("autoNotify", !0) && (C.notifyException(t, null, null, "error"), g()),
									t
								}
								finally {
									x = null
				...
				function c(t, n, i) {
					...
					try {
						if (e.Node && t instanceof e.Node)
							return encodeURIComponent(n) + "=" + encodeURIComponent(_(t));
						var r = [];
						for (var a in t)
				...
				function p(t, e) {
					if (t += "?" + c(e) + "&ct=img&cb=" + (new Date).getTime(), "undefined" != typeof BUGSNAG_TESTING && C.testRequest)
						C.testRequest(t, e);
					else {
				...
				function _(t) {
					if (t) {
						var e = t.attributes;
						if (e) {
							for (var n = "<" + t.nodeName.toLowerCase(), i = 0; i < e.length; i++)
								e[i].value && "null" != e[i].value.toString() && (n += " " + e[i].name + '="' + e[i].value + '"');
							return n + ">"
						}
						return t.nodeName
					}
				...
				function v(t, n, i) {
					...
					r = i(o);
					t[n] = r,
					"undefined" != typeof BUGSNAG_TESTING && e.undo && e.undo.push(function () {
						t[n] = o
					})
				}
				var w,
				...
				C.noConflict = function () {
					return e.Bugsnag = n,
					"undefined" == typeof n && delete e.Bugsnag,
					C
				},
				C.refresh = function () {
					E = 10
				...
				if (h("autoNotify", !0)) {
					v(e, "onerror", function (t) {
						...
						function (n, i, o, r, s) {
							...
							u = {};
							!r && e.event && (r = e.event.errorCharacter),
							a(u),
							x = null,
							c && !z && f({
							...
							"undefined" != typeof BUGSNAG_TESTING && (t = C._onerror),
							t && t(n, i, o, r, s)
						}
					});
					var V = function (t) {
					...
					v(e, "setTimeout", V),
					v(e, "setInterval", V),
					e.requestAnimationFrame && v(e, "requestAnimationFrame", function (t) {
						return function (e) {
							return t(i(e))
						}
					}),
	...
	return Ce.autoNotify = !1,
	Ce.apiKey = "984b96f9e4731b19d6ef03748c94a73a",
	Ce.metaData = {
		embedType: "v4"
	},
	...
	Zt.UI.onReady = function (t) {
		// console.log('index.html Zt.UI.onReady() t.config.note='+t.config.note);
